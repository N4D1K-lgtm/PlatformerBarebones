        ...
        for (int i = 0; i < horizontalRayCount; i ++) {
            ...
            if (hit) {
                ...
                if(!collisions.climbingSlope || slopeAngle > maxClimbAngle) {
                    ...
                    // Set collison left to true if collision detected and directionX is negative.
                    collisions.left = directionX == -1;
                    // Set collison right to true if collision detected and directionX is positive.
    ...
    void verticalCollisions(ref Vector3 velocity) {
        ...
        for (int i = 0; i < verticalRayCount; i ++) {
            ...
            if (hit) {
                ...
                // Set collison below to true if collision detected and directionY is negative.
                collisions.below = directionY == -1;
                // Set collison above to true if collision detected and directionY is positive.
